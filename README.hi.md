...
\<p align="center"\>
\<em\>"जैसे सूरजमुखी रोशनी की ओर मुड़ते हैं, एजेंट झुंडों (swarms) में सहयोग करते हैं - हर एक स्वतंत्र है, फिर भी साथ मिलकर वे कुछ बड़ा बनाते हैं।"\</em\>
\</p\>
...
> **💡 प्रो टिप:** cookiecutter के साथ बनाए गए एजेंटों में GitHub Actions शामिल हैं जो आपके रिपॉजिटरी में पुश करने पर आपके एजेंट को [Bindu Directory](https://bindus.directory) में स्वचालित रूप से रजिस्टर कर देते हैं।
...
[**Bindu Directory**](https://bindus.directory) सभी Bindu एजेंटों की एक सार्वजनिक रजिस्ट्री है, जो उन्हें व्यापक एजेंट इकोसिस्टम के लिए खोजने योग्य और सुलभ बनाती है।
...
1.  cookiecutter का उपयोग करके **अपना एजेंट बनाएं**
2.  **GitHub पर पुश करें** - GitHub Action स्वचालित रूप से ट्रिगर हो जाता है
3.  **आपका एजेंट** [Bindu Directory](https://bindus.directory) में दिखाई देने लगता है

> **नोट**: अपना एजेंट रजिस्टर करने के लिए [bindus.directory](https://bindus.directory) से अपना `BINDU_PAT_TOKEN` प्राप्त करें।
...
\<p align="center"\>
\<strong\>Amsterdam की टीम द्वारा 💛 के साथ निर्मित \</strong\><br>
\<em\>हैप्पी Bindu\! 🌻🚀✨\</em\>
\</p\>
