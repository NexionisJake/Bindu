...
\<p align="center"\>
\<em\>"সূর্যমুখীরা যেমন আলোর দিকে মুখ ফেরায়, এজেন্টরা সেভাবেই ঝাঁকে ঝাঁকে একে অপরের সাথে সহযোগিতা করে - প্রত্যেকে স্বাধীন, তবুও একসাথে তারা মহৎ কিছু তৈরি করে।"\</em\>
\</p\>
...
> **💡 প্রো টিপ:** cookiecutter দিয়ে তৈরি এজেন্টগুলোতে GitHub Actions অন্তর্ভুক্ত থাকে যা আপনার রিপোজিটরিতে কোড পুশ করার সময় স্বয়ংক্রিয়ভাবে [Bindu Directory](https://bindus.directory)-তে আপনার এজেন্টকে রেজিস্টার করে দেয়।
...
[**Bindu Directory**](https://bindus.directory) হলো সকল Bindu এজেন্টের একটি পাবলিক রেজিস্ট্রি, যা সেগুলোকে বৃহত্তর এজেন্ট ইকোসিস্টেমের কাছে দৃশ্যমান এবং অ্যাক্সেসযোগ্য করে তোলে।
...
১. cookiecutter ব্যবহার করে **আপনার এজেন্ট তৈরি করুন**।
২. **GitHub-এ পুশ করুন** - GitHub Action স্বয়ংক্রিয়ভাবে ট্রিগার হবে।
৩. **আপনার এজেন্ট** [Bindu Directory](https://bindus.directory)-তে প্রদর্শিত হবে।

> **নোট**: আপনার এজেন্ট রেজিস্টার করতে [bindus.directory](https://bindus.directory) থেকে আপনার `BINDU_PAT_TOKEN` সংগ্রহ করুন।
...
Bindu হলো **framework-agnostic** এবং নিচের ফ্রেমওয়ার্কগুলোর সাথে পরীক্ষিত:
...
\<p align="center"\>
\<strong\>অ্যামস্টারডামের টিমের পক্ষ থেকে 💛 নিয়ে তৈরি \</strong\><br>
\<em\>হ্যাপি Bindu\! 🌻🚀✨\</em\>
\</p\>
